...
P <- P %>% filter(QUARTER == "H1")

P$AGE2 <- ifelse(P$MONTH==1 & !is.na(P$AGE), P$AGE+1, P$AGE) #If there were any January fish, 1 would have to be added to account for their birthday
